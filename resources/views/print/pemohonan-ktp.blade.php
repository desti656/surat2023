...
<head>
    ...
    <style>
        ...
        * {
        ...
        hr .dotted{
            border: 2px dotted solid !important;
        }
        p, table, ol{
            font-size: 13.5pt;
        }
...
<body>
    ...
    <div class="row">
        ...
        <div class="col-md-8 mx-auto my-2">
            <h2 class="fw-bold text-center p-0" style="font-size: 24px"><u>SURAT BUKTI PERMOHONAN KTP</u></h2>
    ...
    <div class="row">
        <div class="col-md-8 mx-auto">
            <div class="content">
                <p>Yang bertanda tangan dibawah ini Kepala Desa Terong Tawah, Kecamatan Labuapi menerangkan dengan sebenarnya, menerangkan bahwa :</p>
                ...
                <p class="mt-2">
                    Nama tersebut adalah benar warga Desa Ciderum, dan telah mengajukan pemohonan KTP baru/pengganti KTP yang telah habis masa berlakunya, Surat Bukti Pemohonan KTP ini berlaku selama 1 (Stu) bulan/sampai dengan dikerluakannya KTP baru
                </p>
                <p class="mt-2">
                    Demikian Surat Keterangan ini dibuat dan diberikan kepada yang bersangkutan untuk digunakan perlunya
                </p>
                    ...
                    <div>
                        <div class="content-ttd my-4">
                            <div class="d-flex justify-content-end">
                                <div class="mt-4">
                                    <p class="text-center p-0"> </p>
                                    <div class="kolom-ttd">
                                        <h4 class="fw-bold text-center" style="font-size: 14px;">Pemohon,</h4>
                                        <div class="py-4"></div>
