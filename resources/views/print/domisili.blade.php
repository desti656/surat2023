...
<body>
    ...
    <div class="row">
        ...
        <div class="col-md-8 mx-auto my-2">
            <h2 class="fw-bold text-center p-0" style="font-size: 24px"><u>SURAT KETERANGAN DOMISILI</u></h2>
    ...
    <div class="row">
        <div class="col-md-8 mx-auto">
            <div class="content">
                ...
                <p class="mt-3">
                    Dengan ini menerangkan bahwa benar yang bersangkutan di Surat Keterangan ini dibuat untuk pendidikan.
                </p>
                <p class="mt-2">
