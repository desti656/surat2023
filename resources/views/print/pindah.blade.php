...
<body>
    ...
    <div class="row">
        ...
        <div class="col-md-8 mx-auto my-2">
            <h2 class="fw-bold text-center p-0" style="font-size: 24px"><u>SURAT KETERANGAN PINDAH</u></h2>
    ...
    <div class="row">
        <div class="col-md-8 mx-auto">
            <div class="content">
                ...
                <div class="table-responsive">
                    <table class="mx-3">
                        <tbody>
                            ...
                            <tr>
                                <td width="30%">Alamat Tujuan Pindah</td>
                                <td width="1%">:</td>
                                <td >Rifjan Jundila</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td width="30%">Pengikut/ Keluarga yang pindah</td>
                                <td width="1%">:</td>
                                <td >Rifjan Jundila</td>
                            </tr>
                        </tbody>
                ...
                <table class="table table-bondered mx-3">
                    <thead>
                        <th>No</th>
                        <th>NIK</th>
                        <th>NAMA LENGKAP</th>
                ...
                <p class="mt-2">Demikian Surat Keterangan ini diperbuat dengan sebenarnya untuk dapa dipergunakan seperlunya.</p>
